package dev.nkthang.jobsgobe.service.impl.resume;

import dev.nkthang.jobsgobe.model.entity.*;
import dev.nkthang.jobsgobe.model.entity.*;
import dev.nkthang.jobsgobe.payload.request.resume.ResumeLanguageRequest;
import dev.nkthang.jobsgobe.payload.request.resume.ResumeProSkillRequest;
import dev.nkthang.jobsgobe.payload.request.resume.ResumeRequest;
import dev.nkthang.jobsgobe.payload.request.resume.ResumeSoftSkillRequest;
...
import dev.nkthang.jobsgobe.repository.resume.*;
...
import dev.nkthang.jobsgobe.service.iservice.ResumeIService;
import dev.nkthang.jobsgobe.repository.resume.*;
