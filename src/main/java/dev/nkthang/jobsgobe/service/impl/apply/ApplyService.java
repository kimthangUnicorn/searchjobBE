package dev.nkthang.jobsgobe.service.impl.apply;

import dev.nkthang.jobsgobe.common.constants.TypeApply;
...
import dev.nkthang.jobsgobe.payload.response.resume.*;
import dev.nkthang.jobsgobe.payload.response.resume.ResumeApplyResponse;
import dev.nkthang.jobsgobe.payload.response.resume.ResumeLanguageResponse;
import dev.nkthang.jobsgobe.payload.response.resume.ResumeProSkillResponse;
import dev.nkthang.jobsgobe.payload.response.resume.ResumeSoftSkillResponse;
import dev.nkthang.jobsgobe.payload.response.user.UserResponse;
import dev.nkthang.jobsgobe.repository.apply.ApplyRepository;
import dev.nkthang.jobsgobe.repository.job.JobRepository;
import dev.nkthang.jobsgobe.repository.resume.ResumeRepository;
import dev.nkthang.jobsgobe.repository.user.UserRepository;
import dev.nkthang.jobsgobe.service.iservice.ApplyIService;
